...
{mod}`riverarchitect.terraforming` asks what the terrain would have to look like for the features of step 3 to work, and {mod}`riverarchitect.volume_assessment` asks what that costs in earth movement.
